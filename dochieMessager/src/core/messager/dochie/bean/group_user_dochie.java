...
public class group_user_dochie {
	...
	public group_user_dochie() {
		super();
	}
	public group_user_dochie(long _idUsr, long _idGrb) {
		super();
		this._idUsr = _idUsr;
		this._idGrb = _idGrb;
	}
	public group_user_dochie(long _idUsrGrb, long _idUsr, long _idGrb) {
		super();
