...
public class agroup_dochie extends ArrayAdapter<group_dochie>{
	private int textViewResourceId;
	
	public agroup_dochie(Context context, int textViewResourceId) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		group_dochie entry = getItem(position);
		viewHolder.vnamagroup.setText(entry.get_namaGrb());
		viewHolder.vid_group.setText(String.valueOf(entry.get_idGrb()));
		return view;
	}
